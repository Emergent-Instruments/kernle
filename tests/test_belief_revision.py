...
from kernle.storage import SQLiteStorage, Belief, Episode
...
class TestReinforceBeliefs:
    ...
    def test_confidence_has_diminishing_returns(self, kernle_fresh):
        ...
        original_conf = next((b for b in original_beliefs if b.id == belief_id), None).confidence
...
class TestReviseFromEpisode:
    ...
    def test_reinforces_relevant_beliefs(self, kernle_fresh):
        ...
        # Add beliefs
        belief_id = k.belief("I should write tests first", confidence=0.6)
