...
<CardGroup cols={2}>
  ...
  <Card title="33 MCP Tools" icon="plug">
    Complete MCP integration with Claude Desktop, Clawdbot, and other clients
  </Card>
  ...
  <Card title="Stack Architecture" icon="layer-group">
    Multiple memory stacks, any model can load any stack
  </Card>
