...
|--------|---------------|
| `get_episodes` | `*, limit=50, tags=None, context=None, include_forgotten=False` |
| `get_beliefs` | `*, limit=50, belief_type=None, min_confidence=None, include_forgotten=False` |
| `get_values` | `*, limit=50, context=None, include_forgotten=False` |
| `get_goals` | `*, limit=50, status=None, context=None, include_forgotten=False` |
| `get_notes` | `*, limit=50, note_type=None, context=None, include_forgotten=False` |
...
| Method | Signature | Description |
|--------|-----------|-------------|
| `consolidate` | `(*, context=None) -> dict[str, Any]` | Find patterns across episodes, surface common lessons |
...
Components can modify the memory by returning a modified version. Return `None` to leave unchanged.
